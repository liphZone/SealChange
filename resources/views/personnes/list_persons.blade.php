                    ...
                    @foreach ($personne as $personnes)
                        <tr>
                            ...
                            <td>
                                ...
                                <a href="{{ route('retrograde',$personnes->id) }}" title="retrogradrer" onclick="return Action()" class="btn btn-outline-info"> <i class="fa fa-angle-double-down" aria-hidden="true"></i>  </a>
                            </td>
                        </tr>
                    @endforeach
                </tbody>
